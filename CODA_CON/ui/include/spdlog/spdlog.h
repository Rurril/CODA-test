...
//
void set_async_mode(size_t queue_size, const async_overflow_policy overflow_policy = async_overflow_policy::block_retry, const std::function<void()>& worker_warmup_cb = NULL, const std::chrono::milliseconds& flush_interval_ms = std::chrono::milliseconds::zero());
